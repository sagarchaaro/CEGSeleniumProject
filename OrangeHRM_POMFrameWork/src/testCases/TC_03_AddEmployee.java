...
public class TC_03_AddEmployee
{
	...
	public static void before(@Optional(Constant.sTest_ID) String sTestID) throws Exception{
		...
		iTestData=ExcelConfig.getRowContains(sTestID, Constant.col_TestID, Constant.sheet_TestData_AddEmployee);
	...
	public void test() throws Exception{
		try{
			Login_Action.login_Execute(iTestData, Constant.sheet_TestData_AddEmployee);
			...
			Pim_Action.pimAction_Execute(iTestData, Constant.sheet_TestData_AddEmployee);
			Utils.takeScreenShot(driver, sTestName+"_AddEmployee");
			logger.log(LogStatus.INFO, "Login action is succesfully completed. "+logger.addScreenCapture(Constant.screenshotsPath+sTestName+"_AddEmployee.png"));		
